...
**** plot
To display a line plot of the weight moved per workout, use the ~--plot line~ option. Add a horizontal line at the median with ~--median~ or at the mean with  ~--average~.
